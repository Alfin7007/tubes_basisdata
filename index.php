...
//function get_sidebar($page=null){$root_base = $GLOBALS['root_base'];?>
  <html>
    <head>
      <title>Login to WSEC Election</title>
...
<!-- Tabs Titles -->
    <h2 class="active"><font size="6" >Selamat Datang<br><br><br> Pemilihan Ketua Umum Workshop Electro 2020 - 2021<br><br></font></h2>
    <!-- Icon -->
    <div class="fadeIn first" align="center">
      <img src="admin/img/logo formadiksi.png" id="icon" alt="User Icon" height="" width="" />
    </div>
...
<span width="250" style="background-color:#FFFFFF; margin-top:-25;"><h2 class="active">Powered By : Adian Ilham Ramadhan - Muhammad Dhomanhuri Malik Illyas</h2></span>
