...
<body>
  <nav style="height: 60px!important; background-color:#000066">
    <div class="nav-wrapper">
      <a href="#!" class="brand-logo"><img src="../epemilu/admin/img/Polinema.png" width="60" height="60" alt="">
      <img src="../epemilu/admin/img/logo formadiksi.png" width="80" height="80" alt=""></a>
  ...
  <div class="tap-target" data-target="menu">
    <div class="tap-target-content">
      ...
      <p>Baca dahulu sebelum memilih pilihan anda.</p>
        ...
        <footer class="page-footer" style="height: 60px!important; background-color:#000066">
            <div class="container">
            © 2019 Adian Ilham Ramadhan - Muhammad Dhomanhuri Malik Illyas
